...
print("The Tuple value is :",var_tuple_num)#output: The Tuple value is : (1, 2, 3, 4, 6, 5, 7, 88, 5)
...
print("this is the first value of a tuple : ",var_tuple_num[0])#output: this is the first value of a tuple :  1
...
var_tuple_constructor = tuple(("Apple", "Sumsung", "Nokia","Redmi")) # note the double round-brackets
...
print("\nthe index value of 3 after the 3 thrd position and before the  th position is is :", var_tuple_count.index(3,3,9))
...
print("\nthe type of the variable is a tuple :",type(var_tuple_count))#the reverset items of the tuple is : (1, 2, 3, 44, 44, 55, 44, 3, 2, 1, 1, 2, 44, 55, 8)
